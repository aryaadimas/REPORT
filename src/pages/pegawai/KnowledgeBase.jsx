...
export default function KnowledgeBase() {
      ...
      if (Array.isArray(articlesData)) {
        transformedArticles = articlesData.map((article) => {
          ...
          const mainTag =
            Array.isArray(articleTags) && articleTags.length > 0
              ? articleTags[0]
              : { tag_name: "Tanpa Kategori", tag_id: null };

          return {
            article_id:
              article.article_id || article.id || Math.random().toString(),
            title: article.title || "Judul tidak tersedia",
            content:
              article.content || article.description || "Konten tidak tersedia",
            tag_name: mainTag.tag_name,
            tag_id: mainTag.tag_id,
            cover_path: article.cover_path || article.image_url || null,
            author_name:
              article.author?.full_name ||
              article.author?.name ||
              article.author_name ||
              "Admin",
            author_email: article.author?.email || article.author_email,
            tags: articleTags,
        ...
        transformedArticles = articlesData.articles.map((article) => {
          ...
          return {
            ...
            tag_name: mainTag.tag_name,
            tag_id: mainTag.tag_id,
            cover_path: article.cover_path || article.image,
  ...
  const getFallbackData = () => {
    return [
      {
        article_id: "1",
        title: "Cara Login ke Sistem Internal Menggunakan Akun SSO",
        tag_id: "1",
      ...
      },
      {
        ...
        tag_id: "1",
        tag_name: "Akun dan SSO",
        content: "Pellentesque suscipit nunc vel orci rutrum vulputate...",
        author_name: "Admin",
      },
      {
        article_id: "3",
        title: "Cara Reset Password untuk Akun Internal",
        tag_id: "1",
        tag_name: "Akun dan SSO",
        content: "Donec viverra tortor a tristique maximus...",
        author_name: "Admin",
      },
      {
        article_id: "4",
        title: "Cara Membuat Tiket Laporan Internal Baru",
        tag_id: "3",
      ...
      {
        article_id: "5",
        title: "Langkah-Langkah Melihat Status Tiket Internal",
        tag_id: "3",
        tag_name: "Pelaporan dan Pelayanan",
        content: "Pellentesque suscipit nunc vel orci rutrum vulputate...",
        author_name: "Admin",
      ...
      {
        article_id: "7",
        title: "Arti Warna dan Status Tiket Internal",
        tag_id: "3",
        tag_name: "Pelaporan dan Pelayanan",
        content: "Lorem ipsum dolor sit amet, consectetur adipiscing elit...",
        author_name: "Admin",
      ...
      {
        article_id: "8",
        title: "Langkah-Langkah untuk Permohonan Pelayanan Internal",
        tag_id: "3",
        tag_name: "Pelaporan dan Pelayanan",
        content: "Pellentesque suscipit nunc vel orci rutrum vulputate...",
        author_name: "Admin",
      ...
      {
        article_id: "10",
        title: "Tambah Dokumen Pendukung Permintaan Internal",
        tag_id: "2",
      ...
      {
        article_id: "11",
        title: "Cara Mengisi Formulir Pelaporan Internal",
        tag_id: "2",
        tag_name: "Layanan dan Formulir",
        content: "Pellentesque suscipit nunc vel orci rutrum vulputate...",
        author_name: "Admin",
      ...
      {
        article_id: "12",
        title: "Cara Mengisi Formulir Pelayanan Internal",
        tag_id: "2",
        tag_name: "Layanan dan Formulir",
        content: "Donec viverra tortor a tristique maximus...",
        author_name: "Admin",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6">
              {filteredData.length === 0 ? (
                <div className="col-span-full text-center py-8">
                  ...
                  <button
                    onClick={fetchData}
                    className="mt-4 bg-[#226597] text-white px-4 py-2 rounded-lg hover:bg-[#1a5078] transition"
                  >
                    Muat Ulang
                  </button>
                </div>
