...
export default function SuksesLapor() {
  ...
  const ticketResponse = laporanData.ticketData || {};

  const ticketData = {
    noTiket:
      ticketResponse.ticket_code ||
    ...
    judulPelaporan: laporanData.judulPelaporan || "Tanpa Judul",
    dataAset: laporanData.dataAset || "",
    nomorSeri: laporanData.nomorSeri || "",
    kategoriAset: laporanData.kategoriAset || "",
    subKategoriAset: laporanData.subKategoriAset || "",
    jenisAset: laporanData.jenisAset || "",
    lokasiKejadian: laporanData.lokasiKejadian || "",
  };
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      addDataRow("Tanggal Laporan Dibuat", `${ticketData.tanggal}`);
      addDataRow("Jenis Layanan", ticketData.jenisLayanan);
      addDataRow("Ditujukan ke OPD", ticketData.jenisPermohonan);
...
Tanggal Laporan Dibuat: ${ticketData.tanggal} 
Jenis Layanan: ${ticketData.jenisLayanan}
Ditujukan ke OPD: ${ticketData.jenisPermohonan}
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            Data laporan tidak ditemukan. Silakan kembali dan coba lagi.
          </p>
          <button
