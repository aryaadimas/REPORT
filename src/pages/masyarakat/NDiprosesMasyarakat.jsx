...
export default function NotifDiproses() {
    ...
    const fetchNotificationData = async () => {
      try {
        ...
        setNotificationData({
          ...
          message: "Tiket SVD-PO-0078-MA sedang diproses",
          created_at: "2025-12-06T14:52:46.848080",
        });
      } finally {
        setLoading(false);
      }
  ...
  const handleDownloadTicket = async () => {
    ...
    const ticketData = {
      noTiket: notificationData.ticket_code || "SVD-PO-0100-MA",
      jenisLayanan:
        notificationData.request_type === "pelaporan_online"
          ? "Pelaporan Online"
          : notificationData.request_type || "Pengajuan Pelayanan",
      jenisPermohonan: notificationData.nama_dinas || "Dinas Perhubungan",
    ...
    try {
      ...
      doc.text("TIKET LAYANAN", 105, 20, { align: "center" });
      ...
      doc.text("SERVICE DESK", 105, 35, { align: "center" });
      doc.setFontSize(12);
      doc.text("Pemerintah Daerah", 105, 42, { align: "center" });
      ...
      doc.setFont(undefined, "bold");
      doc.text("Jenis Layanan:", 20, 79);
      doc.setFont(undefined, "normal");
      doc.text(ticketData.jenisLayanan, 60, 79);

      doc.setFont(undefined, "bold");
      doc.text("OPD Tujuan:", 20, 86);
      doc.setFont(undefined, "normal");
      ...
      doc.setFontSize(11);
      doc.setTextColor(0, 0, 0);
      doc.text("Tiket ini merupakan bukti pengajuan layanan.", 20, 115);
      doc.text(
      ...
      doc.text("Dokumen ini dicetak secara otomatis oleh sistem", 105, 140, {
        align: "center",
      });
      doc.text(
  ...
  const ticketData = {
    ...
    jenisLayanan:
      notificationData?.request_type === "pelaporan_online"
        ? "Pelaporan Online"
        : notificationData?.request_type || "Pelaporan Online",
    jenisPermohonan: notificationData?.nama_dinas || "Dinas Perhubungan",
  };
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-300 p-6 md:p-8">
              ...
              <div className="space-y-6 text-left">
                ...
                <div className="space-y-2 text-sm md:text-base">
                  ...
                  <p>
                    <span>OPD Tujuan:</span> {ticketData.jenisPermohonan}
                  </p>
                </div>
