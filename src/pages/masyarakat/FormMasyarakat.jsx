...
export default function FormMasyarakat() {
    ...
    const fetchUserData = async () => {
      try {
        ...
        const response = await fetch(
          "https://service-desk-be-production.up.railway.app/me/masyarakat",
          {
            headers: {
  ...
  const handleKirimLaporan = async () => {
    ...
    try {
      ...
      formDataToSend.append("id_opd", selectedOpd.id || 0);
      ...
      const response = await fetch(
        "https://service-desk-be-production.up.railway.app/api/pelaporan-online-masyarakat",
        {
          method: "POST",
          headers: {
            accept: "application/json",
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                    isSubmitting
                      ...
                      : "bg-[#226597] text-white hover:bg-[#1a5078]"
                  }`}
                >
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="px-4 py-2 bg-red-600 border border-red-600 text-white rounded-md text-sm font-medium hover:bg-red-700 transition-colors disabled:bg-gray-400 disabled:border-gray-400"
                >
                  Batalkan
                </button>
              </div>
