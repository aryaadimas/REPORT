...
export default function SuksesPelayanan() {
  ...
  useEffect(() => {
    ...
    if (pengajuanData) {
      console.log("Data diterima:", pengajuanData);
      ...
      const formattedTicketData = {
        ...
        pin: pengajuanData.pin || "228973",
        jenisLayanan: pengajuanData.jenisLayanan || "Pengajuan Pelayanan",
        opdTujuan: pengajuanData.opdTujuan || "Dinas Pendidikan",
        jenisPermohonan: pengajuanData.jenisPermohonan || "Reset Password",
        judulPelaporan: pengajuanData.judulPelaporan || "Router Terganggu",
        dataAset: pengajuanData.dataAset || "Printer HP LaserJet Pro P1102w",
        nomorSeri: pengajuanData.nomorSeri || "HP-LJ-P1102W-001",
        kategoriAset: pengajuanData.kategoriAset || "TI",
        subKategoriAset: pengajuanData.subKategoriAset || "Jaringan",
        jenisAset: pengajuanData.jenisAset || "Barang",
        lokasiKejadian: pengajuanData.lokasiKejadian || "Dispendik Pusat",
...
Sub Kategori Aset: ${ticketData.subKategoriAset}
Jenis Aset: ${ticketData.jenisAset}
Nama Aset: ${ticketData.jenisAset}
...
Dokumen dicetak otomatis dan sah tanpa tanda tangan.
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      doc.setFontSize(8);
      doc.text("© 2025 REPORT – Sistem Pelaporan Layanan.", 20, yPos);
      yPos += 4;
      doc.text(
        "Dokumen dicetak otomatis dan sah tanpa tanda tangan.",
        20,
